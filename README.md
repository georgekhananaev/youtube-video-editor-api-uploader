...
It calls two main functions Video Editor and then Video Uploader.  <br/> Note: You can disable editor or uploader in case you want to use just single function in start_process().
